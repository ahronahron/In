...
<head>
    ...
    <title>Orders Management - PHARMACY Management System</title>
...
<body class="min-h-screen bg-background transition-colors duration-300">
    ...
    <!-- Main Content - Include the rest from orders_management.html -->
    <?php
    // Read the HTML file and extract main content (after </head>)
    $html_file = __DIR__ . '/orders_management.html';
